...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box border green">
            <div class="box-title">
                <h4><i class="fa fa-reorder"></i>Tambah Data provinsi</h4>
            ...
            <div class="box-body big">
                <form class="form-horizontal row-border"  method="post" id="form">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input  class="form-control" type="text" name="nama_provinsi" id="name" placeholder="Ketik Nama provinsi Baru Disini" value="<?php echo (empty($data['data_provinsi']->nama_provinsi) ?  "" : $data['data_provinsi']->nama_provinsi)?>">
                        </div>
                    </div>
...
function sends(){
    $('#form').validate({
        ...
        submitHandler: function(form){
            $.ajax({
                <?php if(empty($data['data_provinsi']->id)){?>
                url: url+'execute/save/tt_provinsi',
                <?php }else{?>
                url: url+"execute/update/tt_provinsi/id/<?php echo $data['data_provinsi']->id;?>",
                <?php }?>
                type: "POST",
                dataType:"json",
                data: $("#form").serialize(),
                ...
                success:function(data){
                    ...
                    setInterval(function() {
                        ...
                        window.location= url+'datautama/provinsi';
                    }, 1000);
                },
