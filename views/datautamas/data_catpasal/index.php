...
<div class="row">
    <div class="col-md-12">
        <!-- BOX -->
        <a  class="btn btn-info btn-md pull-right" href="<?php echo site_url('datautama/catpasal/form');?>">Tambah</a>
                <br/>
                <br/>
                <br/>
        <div class="box border blue">
            <div class="box-title">
                <h4><i class="fa fa-table"></i>Data Kategori Pasal</h4>
            </div>
            <div class="box-body">
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="data">
                    ...
                    <tbody>
                        <?php $no =1; foreach($data_catpasal as $key=>$value){?>
                        <tr>
                            <td><?php echo $no;?></td>
                            <td>
                                <?php echo $value->nama_catpasal; ?></a>
                            </td>
                            ...
                            <td>
                                <a  title="Edit" class="btn btn-warning btn-xs" href="<?php echo site_url('datautama/catpasal/form/'.base64_encode($value->id))?>">Edit</a>
...
function del(btn)
{
    ...
    else
    {
        ...
        $.ajax({
            ...
            url: url+'execute/delete/tt_catpasal/id/'+id,
            type: "POST",
            data:{data_id:id},
            crossDomain:true,
            beforeSend: function(){
...
function update_status(btn){
    ...
    else
    {
        ...
        $.ajax({
            ...
            url: url+'execute/update/tt_catpasal/id/'+id,
            type: "POST",
