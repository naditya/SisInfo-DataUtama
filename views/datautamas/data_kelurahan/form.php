...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box border green">
            <div class="box-title">
                <h4><i class="fa fa-reorder"></i>Tambah Data kelurahan</h4>
            ...
            <div class="box-body big">
                <form class="form-horizontal row-border"  method="post" id="form">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input  class="form-control" type="text" name="nama_kelurahan" id="name" placeholder="Ketik Nama kelurahan Baru Disini" value="<?php echo (empty($data['data_kelurahan']->nama_kelurahan) ?  "" : $data['data_kelurahan']->nama_kelurahan)?>">
                        </div>
                    </div>
...
function sends(){
    $('#form').validate({
        ...
        submitHandler: function(form){
            $.ajax({
                <?php if(empty($data['data_kelurahan']->id)){?>
                url: url+'execute/save/tt_kelurahan',
                <?php }else{?>
                url: url+"execute/update/tt_kelurahan/id/<?php echo $data['data_kelurahan']->id;?>",
                <?php }?>
                type: "POST",
                dataType:"json",
                data: $("#form").serialize(),
                ...
                success:function(data){
                    ...
                    setInterval(function() {
                        ...
                        window.location= url+'datautama/kelurahan';
                    }, 1000);
                },
